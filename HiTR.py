...
class HiTR(object):
    ...
    def runHiTR(self):
        ...
        #m = TM(os.path.join(self.documentsPath, "tmp"), self.ldaPath, self.numTopics)
...
if __name__ == "__main__":
    ...
    ldaPath = "/Users/jiteshdewangan/Desktop/20_newsgroups/Preprocessed-lemmas-shortened-models"
    outPutPath = "/Users/jiteshdewangan/Desktop/20_newsgroups/Preprocessed-lemmas-shortened-models"
    ...
    outPutPath = "/Users/jiteshdewangan/Desktop/Shortcorp/Preprocessed-lemmas-shortened-models"
